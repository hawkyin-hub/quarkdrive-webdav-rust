...
<div class="container">
  <div class="header">
    <h1><a href="https://github.com/hawkyin-hub/quarkdrive-webdav-rust" target="_blank" style="color:inherit;text-decoration:none;">QuarkDrive WebDAV</a></h1>
  ...
  <div class="footer">{total} 个项目 · <a href="https://github.com/hawkyin-hub/quarkdrive-webdav-rust" target="_blank">GitHub</a></div>
</div>
</body>
</html>"#,
